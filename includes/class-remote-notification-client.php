...
div.rn-alert h1, h2, h3, h4, h5, h6 {
	margin-top: 0;
	color: inherit;
}
div.rn-alert a {
...
div.rn-alert>p, div.rn-alert>ul {
	margin-bottom: 0;
}
div.rn-alert>p+p {
	margin-top: 5px;
}
div.rn-alert .rn-dismiss-btn {
...
div.rn-alert-success {
	background-color: #dff0d8;
	border-color: #d6e9c6;
	color: #3c763d;
}
div.rn-alert-success hr {
	border-top-color: #c9e2b3;
}
div.rn-alert-success a {
	color: #2b542c;
}
div.rn-alert-info {
...
div.rn-alert-info hr {
	border-top-color: #a6e1ec;
}
div.rn-alert-info a {
	color: #245269;
}
div.rn-alert-warning {
	background-color: #fcf8e3;
	border-color: #faebcc;
	color: #8a6d3b;
}
div.rn-alert-warning hr {
	border-top-color: #f7e1b5;
}
div.rn-alert-warning a {
	color: #66512c;
}
div.rn-alert-danger {
...
div.rn-alert-danger hr {
	border-top-color: #e4b9c0;
}
div.rn-alert-danger a {
	color: #843534;
}</style>
